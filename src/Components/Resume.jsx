	...
	return (
		<section id="resume">
			<div className="row education">
				...
				<div className="nine columns main-col">
					<div key="Stony Brook University G">
						<h3 className="school">Stony Brook University | Stony Brook, NY</h3>
			...
			<div className="row internship">
				...
				<div className="nine columns main-col">
					<div key="Kitware">
						<h3 className="company">Kitware | Clifton Park, NY</h3>
			...
			<div className="row research">
				...
				<div className="nine columns main-col">
					<div key="HLAB Lab">
						<h3 className="company">Human Language Analysis Beings Lab | Stony Brook, NY</h3>
						<h3 className="role">Research Assistant</h3>
						<p className="date">June 2020 &#8211; Present</p>
						<p className="newline description"></p>
					</div>
					<div key="Ethos Lab">
						<h3 className="company">Ethos Lab | Stony Brook, NY</h3>
						<h3 className="role">Research Assistant</h3>
						<p className="date">September 2019 &#8211; Present</p>
						<p className="newline description"></p>
					</div>
					<div key="Jefferson Lab">
						<h3 className="company">Jefferson Lab | Stony Brook, NY</h3>
						<h3 className="role">Research Assistant</h3>
